 ...
 * @author Anders Jonsson <anders.jonsson@student.lnu.se>
 * @version 1.1.0
 */
...
* @param {string} suitName - The playing card's suit-name.
* @class
*/
export function PlayingCard (rank, suit, suitName) {
  /**
